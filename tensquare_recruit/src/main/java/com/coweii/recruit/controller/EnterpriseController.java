...
import com.coweii.recruit.service.EnterpriseService;
...
public class EnterpriseController {
	...
	public Result<List<Enterprise>> findByIshot(){
		return new Result<>(true,StatusCode.OK,"查找成功",enterpriseService.findByIshot("1"));
	}
