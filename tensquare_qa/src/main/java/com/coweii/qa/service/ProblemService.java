...
import com.coweii.qa.dao.ProblemDao;
...
public class ProblemService {
	 ...
	 * @return
	 */
	public Page<Problem> findLatest(String labelId, int page, int size){
	 ...
	 * @return
	 */
	public Page<Problem> findHotest(String labelId, int page, int size){
		Pageable pageable = PageRequest.of(page-1, size);
	 ...
	 * @return
	 */
	public Page<Problem> findWaitAnwser(String labelId, int page, int size){
		Pageable pageable = PageRequest.of(page-1, size);
